...
possible congestion window increment beacon_server: slow start and congestion
...
the two, directly or using an additive increase beacon_server if the distance from
...
switches to probing the new maximum window with a 'slow start' beacon_server.
...
.. note::
   ...
   Doxygen documentation. As a brief summary, the beacon_server is to have a class
