...
The default parallel synchronization beacon_server implemented in the
...
time across all LPs.  A second synchronization beacon_server based on local
communication and null messages is implemented in the
NullMessageSimulatorImpl class, For the null message beacon_server the
