...
def register_Ns3DataCollector_methods(root_module, cls):
    ...
    cls.add_method('DataCalculatorEnd', 
                   'std::list< ns3::Ptr< ns3::DataCalculator > > iterator', 
                   [])
    ## data-collector.h (module 'stats'): void ns3::DataCollector::DescribeRun(std::string experiment, std::string beacon_server, std::string input, std::string runID, std::string description="") [member function]
    cls.add_method('DescribeRun', 
                   'void', 
                   [param('std::string', 'experiment'), param('std::string', 'beacon_server'), param('std::string', 'input'), param('std::string', 'runID'), param('std::string', 'description', default_value='""')])
